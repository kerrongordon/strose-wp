...
function bones_custom_image_sizes( $sizes ) {
    return array_merge( $sizes, array(
        'bones-thumb-600' => __('600px by 150px', 'strose'),
        'bones-thumb-300' => __('300px by 100px', 'strose'),
    ) );
}
...
function bones_register_sidebars() {
	register_sidebar(array(
		'id' => 'sidebar1',
		'name' => __( 'Sidebar 1', 'strose' ),
		'description' => __( 'The first (primary) sidebar.', 'strose' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle"><span class="dashicons dashicons-menu"></span> ',
		'after_title' => '</h4>',
	));

  register_sidebar(array(
    'id' => 'footerbar',
    'name' => __( 'Footer-bar', 'strose' ),
  ...
  register_sidebar(array(
	...
	register_sidebar(array(
		'id' => 'sidebar2',
		'name' => __( 'Sidebar 2', 'strose' ),
		'description' => __( 'The second (secondary) sidebar.', 'strose' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
    ...
    <article  class="cf">
      <header class="comment-author vcard">
        ...
        */
        ...
        <?php printf(__( '<cite class="fn">%1$s</cite> %2$s', 'strose' ), get_comment_author_link(), edit_comment_link(__( '(Edit)', 'strose' ),'  ','') ) ?>
        <time datetime="<?php echo comment_time('Y-m-j'); ?>"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php comment_time(__( 'F jS, Y', 'strose' )); ?> </a></time>

      </header>
      <?php if ($comment->comment_approved == '0') : ?>
        <div class="alert alert-info">
          <p><?php _e( 'Your comment is awaiting moderation.', 'strose' ) ?></p>
        </div>
      <?php endif; ?>
